  ...
  return (
    <div className={styles.card}>
      ...
      <button 
        ...
        disabled={isDisabled}
        title={isPending ? 'Request pending' : isConnected ? 'Already connected' : 'Send connect request'}
      >
        {isLoading ? 'Sending...' : isPending ? 'Request Sent' : isConnected ? 'Connected' : 'Connect'}
      </button>
    </div>
  );
}
